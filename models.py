...
class Accident(models.Model):
    ...
    place_long = models.DecimalField(db_column='Place_Long', max_digits=10, decimal_places=0)  # Field name made lowercase.
    place_lat = models.DecimalField(db_column='Place_Lat', max_digits=10, decimal_places=0)  # Field name made lowercase.
    ...
    hospital = models.ForeignKey('Hospital', models.DO_NOTHING, db_column='Hospital_ID')  # Field name made lowercase.
...
class Crew(models.Model):
    ...
    vehicle = models.ForeignKey('Vehicles', models.DO_NOTHING, db_column='Vehicle_ID', blank=True, null=True)  # Field name made lowercase.
    accident = models.ForeignKey(Accident, models.DO_NOTHING, db_column='Accident_ID')  # Field name made lowercase.
...
class Employees(models.Model):
    ...
    national_number = models.IntegerField(db_column='National_Number')  # Field name made lowercase.
...
class Reporter(models.Model):
    phone_number = models.IntegerField(db_column='Phone_Number', primary_key=True)  # Field name made lowercase.
    accident = models.ForeignKey(Accident, models.DO_NOTHING, db_column='Accident_ID')  # Field name made lowercase.
    reporter_name = models.CharField(db_column='Reporter_Name', max_length=45)  # Field name made lowercase.
    national_number = models.IntegerField(db_column='National_Number', blank=True, null=True)  # Field name made lowercase.
...
class Station(models.Model):
    ...
    station_type = models.CharField(db_column='Station_Type', max_length=45)  # Field name made lowercase.
    place_long = models.DecimalField(db_column='Place_Long', max_digits=10, decimal_places=0)  # Field name made lowercase.
    place_lat = models.DecimalField(db_column='Place_Lat', max_digits=10, decimal_places=0)  # Field name made lowercase.
    governerate = models.CharField(db_column='Governerate', max_length=45)  # Field name made lowercase.
    city = models.CharField(db_column='City', max_length=45)  # Field name made lowercase.
...
class Vehicles(models.Model):
    ...
    vehicle_number = models.IntegerField(db_column='Vehicle_Number')  # Field name made lowercase.
    special_case = models.CharField(db_column='Special_Case', max_length=45)  # Field name made lowercase.
